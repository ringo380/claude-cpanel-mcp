...
function buildInstructions() {
    const base = 'cpanel-mcp wraps the cPanel UAPI with curated tools plus a generic `uapi_call` escape hatch. ' +
...
const server = new McpServer({ name: 'cpanel-mcp', version: VERSION }, { instructions: buildInstructions() });
