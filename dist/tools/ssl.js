...
export function registerSslTools(server, getClient) {
    server.registerTool('ssl_list_certs', {
    ...
    server.registerTool('ssl_install_cert', {
        ...
        inputSchema: {
            domain: z
                .string()
                .describe('Domain to install the certificate on, e.g. "example.com". Must already be a domain on this account - see domains_list_all.'),
    ...
    server.registerTool('ssl_autossl_status', {
    ...
    server.registerTool('ssl_autossl_run', {
