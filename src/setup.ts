...
function prompt(rl: readline.Interface, question: string, silent = false): Promise<string> {
  return new Promise((resolve) => {
    ...
    out.write(question);
    const stdin = process.stdin as unknown as NodeJS.ReadStream & { isTTY?: boolean };
