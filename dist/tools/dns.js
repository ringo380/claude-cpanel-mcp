...
export function registerDnsTools(server, getClient) {
    server.registerTool('dns_list_zones', {
    ...
    server.registerTool('dns_get_zone_records', {
    ...
    server.registerTool('dns_add_record', {
    ...
    server.registerTool('dns_edit_record', {
        ...
        if (!client)
            return unconfiguredResult();
        try {
            return asJsonContent(await client.call('ZoneEdit', 'edit_zone_record', {
                domain,
                line,
                name,
                type,
    ...
    server.registerTool('dns_remove_record', {
