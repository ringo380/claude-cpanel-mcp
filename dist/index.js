...
const INSTRUCTIONS = 'cpanel-mcp wraps the cPanel UAPI. Run `auth_status` to check whether credentials ' +
...
const server = new McpServer({ name: 'cpanel-mcp', version: VERSION }, { instructions: INSTRUCTIONS });
